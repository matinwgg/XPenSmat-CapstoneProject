...
import { Task } from '../../../../components/CalendarComponents';
    ...
    <Fragment>
      ...
      >
        <CalendarStrip
          ...
          iconLeft={require('../../../../assets/icons/left_arrow.png')}
          iconRight={require('../../../../assets/icons/right_arrow.png')}
        ...
        >
          <Image
            source={require('../../../../assets/icons/plus_c.png')}
            style={{
              height: 30,
              width: 30
            }}
